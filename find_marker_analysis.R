...
seurat_merged_qc <- readRDS("C:......./Github project/seurat_merged_qc)
seurat_markers <- readRDS("C:....../Github project/seurat_markers.rds")
head(seurat_markers)
tail(seurat_markers)
...
cluster_colors <- brewer.pal(n = max(3, n_clusters), name = "Paired") 
